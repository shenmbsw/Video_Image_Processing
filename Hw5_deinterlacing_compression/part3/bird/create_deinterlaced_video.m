[h,w,c] = size(imread('birds_interl/birds_interl_1.tif'));
H = h*2;
F = {};
for i = 1:2:59
    name_1=strcat('birds_interl/birds_interl_',num2str(i+1),'.tif');
    frame1 = imread(name_1);
    name_2=strcat('birds_interl/birds_interl_',num2str(i),'.tif');
